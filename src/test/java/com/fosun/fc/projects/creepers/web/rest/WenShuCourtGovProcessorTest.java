...
public class WenShuCourtGovProcessorTest implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        for (Page eachPage : pageList) {
            ...
            for (int index = 1; index < divList.size() + 1; index++) {
                ...
                // System.out.println(eachPage.getResultItems().get("title" +
                // index));
                // System.out.println(eachPage.getResultItems().get("docId" +
                // index));
    ...
    public static void main(String[] args) throws IOException {
        ...
        Spider.create(new WenShuCourtGovProcessorTest()).thread(1)
                ...
                .setDownloader(new AddMouseCheckSeleniumDownloader(
                        BaseConstant.SeleniumWebDriverPath.CHROME_PATH.getValue()))
