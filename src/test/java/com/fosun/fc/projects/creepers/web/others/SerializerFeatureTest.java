package com.fosun.fc.projects.creepers.web.others;
...
//        showJsonBySelf();
        ...
        nameValuePairs[0]=new BasicNameValuePair("page", "1");
        nameValuePairs[1]=new BasicNameValuePair("size", "5");
        request.putExtra(BaseConstant.POST_NAME_VALUE_PAIR, nameValuePairs);
        String requsetStr = JSON.toJSONString(request);
        Request request2 = JSONObject.parseObject(requsetStr,Request.class);
    ...
    private static void showJsonBySelf() {
        String wordStr=JSON.toJSONString(word);
        Word word = JSONObject.parseObject(wordStr,Word.class);
        System.out.println(wordStr);
        String featureStr=JSON.toJSONString(word, SerializerFeature.PrettyFormat,
