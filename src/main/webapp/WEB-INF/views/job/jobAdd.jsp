							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										...
										<div class="form-group">
											<label class="col-md-2 control-label">断点URL</label>
											<div class="col-md-3">
												<input class="form-control" type="text" id="indexUrl"
													name="indexUrl" value="${indexUrl}">
											</div>
											...
											<div class="col-md-3">
												<input class="form-control" type="text" id="threadNum"
													...
													placeholder="任务启动的线程数最少为1(即单线程),且目前只支持单线程">
											</div>
										</div>
										<div class="form-group">
											<input type="hidden" id="status" name="status" value="NORMAL">
											<input type="hidden" id="searchJobName" name="searchJobName" value="${searchJobName }">
											<input type="hidden" id="searchJobGroup" name="searchJobGroup" value="${searchJobGroup }">
