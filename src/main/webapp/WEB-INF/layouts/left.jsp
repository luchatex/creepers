...
<div class="sidebar">
	...
	<ul id="nav">
		...
		<li class="has_sub"><a href="#"> <i class="icon-list-alt"></i>爬取任务管理
			...
			<ul>
				<li><a href="${ctx}/creeperTask/toAddTask">按需任务管理</a></li>
				<li><a href="${ctx}/job/init">全量定时任务管理</a></li>
				<li><a href="${ctx}/taskList/toInitTaskList">全量任务url初始化</a></li>
				<li><a href="${ctx}/taskList/toResumeTask">全量任务断点续爬</a></li>
			</ul></li>
		...
		<li class="has_sub"><a href="#"><i class="icon-list-alt"></i>
			...
			<ul>
				...
				<li><a href="${ctx}/monitor/toPerformanceMonitor">性能监控</a></li>
			</ul></li>
		<!--
