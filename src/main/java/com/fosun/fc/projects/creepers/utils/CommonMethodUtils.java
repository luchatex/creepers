...
public class CommonMethodUtils {
                ...
                for (int i = 0; i < fs.length; i++) {
                    if (key.equals(fs[i].getName())) {
                        ...
                        try {
                            ...
                            throw new ParseException("[mapTransDTO]ParseException异常-->一般是类型转换错误，主要出现在日期转换处", 0);
                        }
                    }
                }
            }
    ...
    public static Request buildDefaultRequest(Map<String, String> nameValuePairMap,Request request) {
        return buildDefaultRequest(nameValuePairMap, request.getUrl());
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // List<Map<String, String>> allTaskList =
        // BaseConstant.getAllDataTaskListTypeList();
        ...
        // System.out.println(matchesValue("[\u4e00-\u9fa5]+","企业名称                                                                        // (中文）"));//
                                                                                                                                        ...
                                                                                                                                        // (中文）".replaceAll("[^\u4e00-\u9fa5]",
                                                                                       // ""));
//        String medicalInstrumentDomesticJson = "[{\"代理人名称\":\"\",\"结构及组成\":\"\",\"注册证编号\":\"京药监械(准)字2011第2260135号\",\"批准日期\":\"2011.02.18\",\"主要组成成分（体外诊断试剂）\":\"\",\"预期用途（体外诊断试剂）\":\"\",\"变更情况\":\"\",\"注\":\"本网站发布的医疗器械产品注册与备案信息供参考。如网站公布的信息与纸质批件不一致，请相关企业与我们联系纠错，纠错电话：010-88330123。如企业在数据库中未查到本企业产品注册、备案信息，请企业联系省局或市局。\",\"适用范围\":\"\",\"注册人名称\":\"北京天长福医疗设备制造有限公司\",\"备注\":\"\",\"有效期至\":\"2015.02.17\",\"其他内容\":\"\",\"产品标准\":\"YZB/京0228-2009T99-C电脑中频电疗仪\",\"审批部门\":\"\",\"产品名称\":\"电脑中频电疗仪\",\"注册人住所\":\"\",\"产品储存条件及有效期（体外诊断试剂）\":\"\",\"生产地址\":\"北京市丰台区永外东铁匠营五间楼十号B座332、336室\",\"变更日期\":\"\",\"邮编\":\"\",\"型号、规格\":\"t99-c\",\"代理人住所\":\"\"}]";
//        String medicalInstrumentForeignJson = "[{\"代理人名称\":\"罗氏诊断产品(上海)有限公司\",\"批准日期\":\"2013.08.22\",\"主要组成成分（体外诊断试剂）\":\"\",\"预期用途（体外诊断试剂）\":\"\",\"变更情况\":\"\",\"适用范围\":\"用于罗氏的配套的分析仪上进行钠离子定量检测。\",\"备注\":\"\",\"有效期至\":\"2017.08.21\",\"其他内容\":\"\",\"产品名称（中文）\":\"钠电极\",\"产品标准\":\"YZB/GER 4276-2013《钠电极》\",\"审批部门\":\"\",\"注册人住所\":\"Sandhofer Strasse 116, 68305 Mannheim, Germany\",\"生产国或地区（英文）\":\"\",\"生产地址\":\"A-8020 Graz, Kratkystrasse 2, Austria；Forrenstrasse 2, 6343 Rotkreuz, Switzerland\",\"变更日期\":\"\",\"售后服务机构\":\"罗氏诊断产品(上海)有限公司\",\"结构及组成\":\"主要组成是钠电极。\",\"注册证编号\":\"国食药监械(进)字2013第2403413号\",\"生产国或地区（中文）\":\"德国\",\"注\":\"网站发布的医疗器械产品注册与备案信息供公众查询,如网站公布的信息与原纸质批件不一致,请相关企业与我们联系纠错。电话:010-88330123。\",\"注册人名称\":\"\",\"产品名称\":\"Sodium Electrode\",\"产品储存条件及有效期（体外诊断试剂）\":\"\",\"生产厂商名称（中文）\":\"德国罗氏诊断有限公司\",\"型号、规格\":\"Sodium Electrode\",\"代理人住所\":\"\"}]";
//        String medicalGSPJson = "[{\"有效期截止日\":\"2011.08.28\",\"企业名称\":\"桃源县正康大药房有限责任公司城南店\",\"认证范围\":\"零售\",\"注\":\"本数据库内容供参考。如发现本页面内容有误，请登陆省局网站查看GSP证书数据库中相应内容是否与证书一致，如一致，请将GSP证书传真到总局010-68355521；如不一致，请先联系省局修改省局网站上的数据后再发传真。如省局网站没有经营许可证书数据库，请联系省局。\",\"地址\":\"漳江镇漳江南路\",\"备注\":\"\",\"证书编号\":\"C-Hun06-0753\",\"发证时间\":\"2006.08.29\",\"省市\":\"湖南\"}]";
//        String medicalGMPJson = "[{\"批准延续的认证范围\":\"\",\"企业名称\":\"广西百草堂药业有限公司\",\"有效期延续至\":\"\",\"注\":\"本数据库内容供参考。如发现本页面内容有误，请登陆省局网站查看GMP证书数据库中相应内容是否与证书一致，如一致，请将GMP证书传真到总局010-68355521；如不一致，请先联系省局修改省局网站上的数据后再发传真。如省局网站没有GMP证书数据库，请联系省局登陆总局专网中省局GMP认证系统确认系统中数据与证书一致后再发传真。\",\"备注\":\"\",\"认证GMP版本\":\"按1998年修订药品GMP认证\",\"省市\":\"广西\",\"批准延续日期\":\"\",\"有效期截止日\":\"2011.01.25\",\"认证范围\":\"颗粒剂\",\"发证日期\":\"2006.01.26\",\"地址\":\"\",\"证书编号\":\"桂H0163\"}]";
//        TranslateMethodUtil.jsonArrayKeyC2P(medicalGMPJson);
        String mapValue = " ";
        java.util.Date date=DateUtils.parseDate((String) mapValue,BaseConstant.DateFormatPatternTypeArr.TYPE_ARRAY.getArr());
//        String url = "http://qy1.sfda.gov.cn/datasearch/face3/content.jsp?tableId=24&tableName=TABLE24&tableView=GSP%C8%CF%D6%A4&Id=";
        System.out.println(date.toString());
//        http://qy1.sfda.gov.cn/datasearch/face3/content.jsp?tableId=24&tableName=TABLE24&tableView=GSP%C8%CF%D6%A4&Id=209321
//        http://qy1.sfda.gov.cn/datasearch/face3/content.jsp?tableId=24&tableName=TABLE24&tableView=GSP%C8%CF%D6%A4&Id=209321
    }
}
