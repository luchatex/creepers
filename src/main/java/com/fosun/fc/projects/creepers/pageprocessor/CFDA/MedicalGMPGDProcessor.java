    ...
    public void process(Page page) {
        ...
        if (page.getUrl().toString().equals(param.getOrderUrl(BaseConstant.OrderUrlKey.INDEX_URL))) {
            ...
            if (CommonMethodUtils.isEmpty(trList)) {
                ...
                Map<String, String> map = new HashMap<String, String>();
                map.put("province", "广州");
                TranslateMethodUtil.addCommonParamMapMedical(list, CreepersConstant.TCreepersMedicalColumn.TYPE.getValue(), BaseConstant.TaskListType.MEDICAL_GMP_LIST.getValue(), map);
