...
public class CreepersConstant {
    ...
    public static enum TableNamesCreditChina {
        ...
        // 行政处罚黑名单
        T_CREEPERS_ADMIN("tCreepersAdmin", true),
        // 信用中国黑名单
        T_CREEPERS_CREDIT_BLACK_LIST("tCreepersCreditBlackList", true);
    ...
    public static enum TableNamesOthers {
        ...
        // 天眼查工商基础信息
        T_CREEPERS_TYC_BASE_INFO("tCreepersTycBaseInfo", false),
        // 天眼查工商基础信息
        T_CREEPERS_COMPANY_LIST("tCreepersCompanyList", false),
        //信用江苏公布的法院失信被执行人
        T_CREEPERS_DISHONEST_JIANGSU("tCreepersDishonestJiangsu", false),
        // 百度失信被执行人信息
        T_CREEPERS_DISHONEST_BAIDU("tCreepersDishonestBaidu", false);
    ...
    public static enum TableNamesFund {
        ...
        // 住房公积金贷款信息
        T_CREEPERS_FUND_LOANS("tCreepersFundLoans", false),
        // 爬虫任务队列-公积金信息
    ...
    public static enum TCreepersTaskListColumn {// 爬虫任务队列表
        // 任务类型
        TASK_TYPE("taskType"),
        // 任务链接
        URL("url"),
        ...
        // 参数说明
        PARAM_MAP("paramMap");
        private TCreepersTaskListColumn(String string) {
            this.value = string;
        }
    ...
    public static enum TCreepersAdminColumn {// 信用中国-行政公告信息
        // 主键
        ID("id"),
        ...
        // 修改时间
        UPDATED_DT("updatedDt");
        private TCreepersAdminColumn(String string) {
            this.value = string;
        }
    ...
    public static enum TCreepersTycBaseInfoColumn {// 天眼查工商基础信息
        // ID
        ID("id"),
        // 企业名字
        NAME("name"),
        ...
        // 备注
        MEMO("memo"),
        // 状态，0：默认待处理、1：已处理成功、2：处理失败、3：任务处理中
        FLAG("flag"),
        // 乐观锁
        VERSION("version"),
        // 创建者
        ...
        // 修改时间
        UPDATED_DT("updatedDt");
        private TCreepersTycBaseInfoColumn(String string) {
            this.value = string;
        }
    ...
    public static enum TCreepersCreditBlackListColumn
    ...
    {// 信用中国其他黑名单表
     // 主键
        ...
        private TCreepersCreditBlackListColumn(String string) {
            this.value = string;
        }
    ...
    public static enum TCreepersCompanyListColumn {// 企业名录
        // 主键
        ID("id"),
        // 企业名称
        NAME("name"),
        ...
        // 修改时间
        UPDATED_DT("updatedDt");
        private TCreepersCompanyListColumn(String string) {
            this.value = string;
        }
        ...
        public static enum TCreepersDishonestBaiduColumn {// 百度-失信被执行人信息
            // 主键
            ID("id"),
            // 名字
            NAME("name"),
            ...
            // 修改时间
            UPDATED_DT("updatedDt");
            private TCreepersDishonestBaiduColumn(String string) {
                this.value = string;
            }
        ...
        public static enum TCreepersBusinessTagColumn {// 爬虫业务标签定义表
            // 主键
            ID("id"),
            // 任务类型
            TASK_TYPE("taskType"),
            ...
            // 修改时间
            UPDATED_DT("updatedDt");
            private TCreepersBusinessTagColumn(String string) {
                this.value = string;
            }
        ...
        public static enum TCreepersTotalNameListColumn {// 企业全名录
            // 主键
            ID("id"),
            // 企业名称
            NAME("name"),
            ...
            // 修改时间
            UPDATED_DT("updatedDt");
            private TCreepersTotalNameListColumn(String string) {
                this.value = string;
            }
    ...
    public static enum TCreepersFundLoansColumn {// 公积金账户贷款明细表
        // 主键
        ID("id"),
        // 登录账号
        LOGIN_NAME("loginName"),
        ...
        // 账户状态
        LOAN_ACCOUNT_STATUS("loanAccountStatus"),
        // 贷款开户日期
        LOAN_DT("loanDt"),
        // 贷款期限
        PERIOD("period"),
        ...
        // 末次还款年月
        LAST_REPAYMENT_DT("lastRepaymentDt"),
        // 备注
        MEMO("memo"),
        // 逻辑删除标志，0：未删除，1：已删除
        FLAG("flag"),
        ...
        // 修改时间
        UPDATED_DT("updatedDt");
        private TCreepersFundLoansColumn(String string) {
            this.value = string;
        }
