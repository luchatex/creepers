...
public class TranslateMethodUtil {
    ...
    public static void addCommonParamMapMedical(List<Map<String, String>> sourceList, String key, String value) {
        Map<String, String> outMapParam = new HashMap<String, String>();
        outMapParam.put(key, value);
        addCommonParamMapMedical(sourceList, outMapParam, null);
    }

    public static void addCommonParamMapMedical(List<Map<String, String>> sourceList, String key, String value, Map<String, String> inMapParam) {
        Map<String, String> outMapParam = new HashMap<String, String>();
        outMapParam.put(key, value);
        addCommonParamMapMedical(sourceList, outMapParam, inMapParam);
    }

    public static void addCommonParamMapMedical(List<Map<String, String>> sourceList, Map<String, String> outMapParam, Map<String, String> inMapParam) {
        List<Map<String, String>> resultList = new ArrayList<Map<String, String>>();
        for (Map<String, String> sourceMap : sourceList) {
            String keyValue = sourceMap.get(CreepersConstant.TCreepersMedicalColumn.KEY.getValue());
            if (!CommonMethodUtils.isEmpty(inMapParam))
                sourceMap.putAll(inMapParam);
            ...
            if (!CommonMethodUtils.isEmpty(outMapParam))
                entityMap.putAll(outMapParam);
    ...
    public static String jsonArrayKeyC2P(String jsonStr, boolean replace) {
        ...
        return jsonConvertKeyChineseToPinyin(jsonStr, BaseConstant.JSONStringType.JSON_ARRAY.getValue(), replace);
    }
    ...
    public static String jsonObjectKeyC2P(String jsonStr, boolean replace) {
        ...
        return jsonConvertKeyChineseToPinyin(jsonStr, BaseConstant.JSONStringType.JSON_OBJECT.getValue(), replace);
    }
    ...
    public static String jsonConvertKeyChineseToPinyin(String sourceJsonString, String type, boolean replace) {
        ...
        if (BaseConstant.JSONStringType.JSON_ARRAY.getValue().equals(type)) {
            ...
            for (Object object : sourceJsonArray) {
                ...
                for (String key : keySet) {
                    ...
                    if (replace) {
                        if (!CommonMethodUtils.matches("[\\u4e00-\\u9fa5]+", key)) {
                            String pinyinKey = ChineseUtil.converterToSpell(CommonMethodUtils.matchesChineseValue(key));
...
//                        System.out.println(ChineseUtil.converterToSpell(key)+"\t"+key);
        ...
        } else if (BaseConstant.JSONStringType.JSON_OBJECT.getValue().equals(type)) {
            JSONObject jsonObj = new JSONObject();
            ...
            for (String key : keySet) {
                ...
                if (replace) {
                    jsonObj.put(ChineseUtil.converterToSpell(CommonMethodUtils.matchesChineseValue(key)), value);
                } else {
                    jsonObj.put(ChineseUtil.converterToSpell(key), value);
                }
            }
