...
public class BaseConstant {
    ...
    public static final String PARAM_EXTRA_CURRENT_DETAIL_NO = "detailNo";
    public static final String PARAM_EXTRA_TOTAL_PAGE_NO = "totalPage";
    public static final String PARAM_EXTRA_TOTAL_DETAIL_NO = "totalDetail";
    ...
    public static final String HTTP_CLIENT_CONTEXT = "httpClientContext";
    ...
    public static final String POST_NAME_VALUE_PAIR_STRING = "nameValuePairString";
    ...
    public static String[] USER_AGENT_ARRAY = { "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_8; en-us) AppleWebKit/534.50 (KHTML, like Gecko) Version/5.1 Safari/534.50",
            ...
            // AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8J2
            // Safari/6533.18.5",
            // "Mozilla/5.0 (Linux; U; Android 2.3.7; en-us; Nexus One
            // Build/FRF91) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0
            // Mobile Safari/533.1",
            // "MQQBrowser/26 Mozilla/5.0 (Linux; U; Android 2.3.7; zh-cn; MB200
            // Build/GRJ22; CyanogenMod-7) AppleWebKit/533.1 (KHTML, like Gecko)
            // Version/4.0 Mobile Safari/533.1",
            // "Opera/9.80 (Android 2.3.4; Linux; Opera Mobi/build-1107180945;
            // U; en-GB) Presto/2.8.149 Version/11.10",
            // "Mozilla/5.0 (Linux; U; Android 3.0; en-us; Xoom Build/HRI39)
            // AppleWebKit/534.13 (KHTML, like Gecko) Version/4.0
            // Safari/534.13",
            ...
            // AppleWebKit/534.6 (KHTML, like Gecko) wOSBrowser/233.70
            ...
            // like Gecko) BrowserNG/7.1.18124",
    ...
    public static List<Map<String, String>> getAllDataTaskListRedis() {
        return getTaskListTypeList(TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL);
    }
    ...
    public static enum TaskListParentType {
        ...
        // 通过批量取detailURL push到redis 启动任务的方式。
        PUST_REQUEST_TO_REDIS_SEARCH_ALL;
    ...
    public static enum TaskListType {
        ...
        // 药品GSP认证
        MEDICAL_GSP_LIST("medical_GSP_list", "药品GSP认证", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 药品GMP认证
        MEDICAL_GMP_LIST("medical_GMP_list", "药品GMP认证", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 偷税漏税信息
        TAX_EVASION_LIST("tax_evasion_list", "偷税漏税黑名单", TaskListParentType.SINGLE_SEARCH_ALL_DATA),
        // 医疗器械注册信息---国产
        MEDICAL_INSTRUMENT_DOMESTIC_LIST("medical_instrument_domestic_list", "国产医疗器械注册信息", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 医疗器械注册信息---进口
        MEDICAL_INSTRUMENT_FOREIGN_LIST("medical_instrument_foreign_list", "进口医疗器械注册信息", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 行政许可
        ADMIN_LICENSE_LIST("admin_license_list", "行政许可", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 行政处罚
        ADMIN_SACTION_LIST("admin_saction_list", "行政处罚", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 天眼查工商基础信息
        TYC_BASE_INFO("tyc_base_info", "天眼查工商基础信息", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 信用中国黑名单--限制发行企业债黑名单信息
        CORP_BONDS_LIST("corp_bonds_list", "限制发行企业债黑名单信息", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 信用中国黑名单--限制参与工程招标黑名单信息
        BIDDING_BLACK_LIST("bidding_black_list", "限制参与工程招标黑名单信息", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 顺企黄页公司信息
        COMPANY_LIST("company_list", "顺企黄页公司信息", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 数据中华
        ALL_CHINA_DATA("all_china_data", "数据中华", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 信用北京行政处罚
        BEIJING_ADMIN_SACTION_LIST("beijing_admin_saction_list", "信用北京行政处罚", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 信用浙江行政处罚
        ZHEJIANG_ADMIN_SACTION_LIST("zhejiang_admin_saction_list", "信用浙江行政处罚", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 信用江苏行政处罚
        JIANGSU_ADMIN_SACTION_LIST("jiangsu_admin_saction_list", "信用江苏行政处罚", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 失信被执行人-江苏
        DISHONEST_JIANGSU_LIST("dishonest_jiangsu_list", "失信被执行人-江苏", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 失信被执行人-百度
        DISHONEST_BAIDU_LIST("dishonest_baidu_list", "失信被执行人-百度", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        // 信用中国工商注册号查询
        BUSINESS_REG_NO("business_reg_no", "信用中国工商注册号查询", TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        //失信被执行人-百度-按名录爬取
        DISHONEST_BAIDU_LIST_BY_NAME_LIST("dishonest_baidu_list_by_name_list","失信被执行人-百度-按名录爬取",TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        //失信被执行人-百度-按全名录爬取
        DISHONEST_BAIDU_LIST_BY_TOTAL_NAME_LIST("dishonest_baidu_list_by_total_name_list","失信被执行人-百度-按全名录爬取",TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL),
        //失信被执行人-临时
        TEMP_SHIXIN_LIST("temp_shixin_list","失信被执行人-临时",TaskListParentType.PUST_REQUEST_TO_REDIS_SEARCH_ALL);
        // 任务列表类型
        private String value;
        // 管理界面下拉框显示中文名字
    ...
    public static enum TaskListFlag {
        // 默认待处理
        DEFAULT("0"),
        // 已处理成功
        COMPLETED("1"),
        ...
        private TaskListFlag(String str) {
            this.value = str;
        }
    ...
    public static enum DateFormatPatternType {
        ...
        // yyyy/MM/dd hh:mm:ss
        TYPE_FIV("yyyy/MM/dd HH:mm:ss.SSS");
        public String getValue() {
            return value;
        }
    ...
    public static enum ProcessByRedisType {
        // 全量
        WHOLE_DATA("0"),
        // 全量数据单次10W条
        WHOLE_DATA_MAX_10W("1"),
        // 断点数据
        BREAK_POINT_DATA("2");
        ...
        private ProcessByRedisType(String string) {
            this.value = string;
        }
    }
    ...
    public static void main(String args[]) {
        TaskListType[] taskType = TaskListType.values();
        for (TaskListType taskListType : taskType) {
            System.err.println(BaseConstant.TaskListType.valueOf(taskListType.getValue().toUpperCase()).getNameChinese());
        }
    }
}
