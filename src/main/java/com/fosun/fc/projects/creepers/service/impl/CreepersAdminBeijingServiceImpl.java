...
import com.fosun.fc.projects.creepers.pageprocessor.CreditChina.AdminBeijingProcessor;
import com.fosun.fc.projects.creepers.pipeline.CreditChina.AdminBeijingPiepline;
...
@Service
@Transactional
public class CreepersAdminBeijingServiceImpl implements ICreepersAdminBeijingService{

	 private Logger logger = LoggerFactory.getLogger(getClass());
	 
	 public final static String TYPE_AREA = "北京";
	
	@Autowired
	private AdminBeijingProcessor adminBeijingProcessor;
	
	@Autowired
	private AdminBeijingPiepline adminBeijingPiepline;
	...
	public void processByRequest(String taskType) {
		...
		// 启动爬虫
        logger.info("=============>>启动爬虫!");
        Spider spider = Spider.create(adminBeijingProcessor).addPipeline(adminBeijingPiepline)
