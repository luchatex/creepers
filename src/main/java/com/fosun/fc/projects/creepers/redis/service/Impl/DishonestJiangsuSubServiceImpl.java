...
public class DishonestJiangsuSubServiceImpl implements IRedisSubService {
    ...
    public void handleMessage(Serializable message) {
        ...
        logger.info("=============>DishonestJiangsuSubServiceImpl.handleMessage start!");
        //接收消息
        String taskType = message.toString();
        //增加异常处理
        try {
            creepersDishonestJiangsuServiceImpl.processByRequest(taskType);
            logger.info("=============>DishonestJiangsuSubServiceImpl.handleMessage end!");
        } catch (Exception e) {
            e.printStackTrace();
            //异常处理
            ...
            logger.error("=============>DishonestJiangsuSubServiceImpl.handleMessage end!");
        }
