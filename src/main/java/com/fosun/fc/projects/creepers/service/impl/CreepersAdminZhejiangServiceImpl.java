...
import com.fosun.fc.projects.creepers.pageprocessor.CreditChina.AdminZhejiangProcessor;
import com.fosun.fc.projects.creepers.pipeline.CreditChina.AdminZhejiangPiepline;
...
@Service
@Transactional
public class CreepersAdminZhejiangServiceImpl implements ICreepersAdminZhejiangService{

	private Logger logger = LoggerFactory.getLogger(getClass());

	@Autowired
	private AdminZhejiangProcessor adminZhejiangProcessor;
	
	@Autowired
	private AdminZhejiangPiepline adminZhejiangPiepline;
	...
	public void processByRequest(String taskType) {
		...
		// 启动爬虫
        logger.info("=============>>启动爬虫!");
        Spider spider = Spider.create(adminZhejiangProcessor).addPipeline(adminZhejiangPiepline)
