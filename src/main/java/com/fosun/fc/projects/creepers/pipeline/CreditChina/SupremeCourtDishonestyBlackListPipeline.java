        ...
        try {
            ...
            if (!CommonMethodUtils.isEmpty(dishonestyMapList)) {
                ...
                if (!CommonMethodUtils.isEmpty(disInfoMapList)) {
                    // map转entity
                    List<TCreepersCourtDisInfo> detailEntityList = CommonMethodUtils.mapList(disInfoMapList,
                            new TCreepersCourtDisInfo());
                    Map<String, String> map = new HashMap<String, String>();
                    for (TCreepersCourtDisInfo entity : detailEntityList) {
                        CommonMethodUtils.setByDT(entity);
                    ...
                    creepersCourtDisInfoServiceImpl.saveEntity(detailEntityList);
                }
