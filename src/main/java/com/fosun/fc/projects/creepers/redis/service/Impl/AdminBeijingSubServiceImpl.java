...
public class AdminBeijingSubServiceImpl implements IRedisSubService {
    ...
    public void handleMessage(Serializable message) {
        ...
        logger.info("=============>AdminBeijingSubServiceImpl.handleMessage start!");
        //接收消息
        String taskType = message.toString();
        //增加异常处理
        try {
        	creepersAdminBeijingServiceImpl.processByRequest(taskType);
            logger.info("=============>AdminBeijingSubServiceImpl.handleMessage end!");
        } catch (Exception e) {
            e.printStackTrace();
            //异常处理
            ...
            logger.error("=============>AdminBeijingSubServiceImpl.handleMessage end!");
        }
