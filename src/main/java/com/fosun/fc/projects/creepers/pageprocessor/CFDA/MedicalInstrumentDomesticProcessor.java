 ...
 * 
 * @author MaXin
 * @since 2016-11-22 09:39:14
 * @see
 */
@Component("medicalInstrumentDomesticProcessor")
public class MedicalInstrumentDomesticProcessor extends BaseMedicalProcessor implements PageProcessor {

    public static final String INDEX_URL = "http://qy1.sfda.gov.cn/datasearch/face3/search.jsp?tableId=26&bcId=118103058617027083838706701567";

    Logger logger = LoggerFactory.getLogger(this.getClass());

    private Site site;

    public MedicalInstrumentDomesticProcessor() {
        if (null == site) {
            site = Site.me().setDomain("qy1.sfda.gov.cn").setUserAgent(CommonMethodUtils.getRandomUserAgent())
                    ...
                    .setSleepTime(CommonMethodUtils.randomSleepTime()).setTimeOut(90 * 000);
        }
    ...
    public void process(Page page) {
        ...
        logger.warn("========================>>MedicalInstrumentDomesticProcessor:  start");
        ...
        result.put(CreepersConstant.TCreepersMedicalColumn.TYPE.getValue(), BaseConstant.TaskListType.MEDICAL_INSTRUMENT_DOMESTIC_LIST.getValue());
        ...
        logger.warn("========================>>MedicalInstrumentDomesticProcessor:  end");
    }
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new MedicalInstrumentDomesticProcessor()).setDownloader(new DungProxyDownloader().setParam(param))
