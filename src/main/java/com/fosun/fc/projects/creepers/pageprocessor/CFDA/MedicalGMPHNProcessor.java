...
@Component
public class MedicalGMPHNProcessor extends BaseCreepersListProcessor implements PageProcessor {
    ...
    private static final String ACCESS_SEARCH_URL = "/wbpp/generalsearch?sort=true&sortId=CTIME&columnid=CLID%7CBCID&relation=MUST%7CMUST&tableName=Region&colNum=2&qryNum=2&curPage=1&qryidstr=CLID%7CBCID&qryValue=cl0885%7C0018&record=20&mytarget=~blank&dateFormat=yyyy%C4%EAMM%D4%C2dd%C8%D5&titleLength=-1&subTitleFlag=0&classStr=%7C-1%7C-1%7CListColumnClass15%7CLawListSub15%7Clistnew15%7Clisttddate15%7Clistmore15%7Cdistance15%7Cclasstab15%7Cclasstd15%7CpageTdSTR15%7CpageTdSTR15%7CpageTd15%7CpageTdF15%7CpageTdE15%7CpageETd15%7CpageTdGO15%7CpageTdGOTB15%7CpageGOButton15%7CpageDatespan15%7Cpagestab15%7CpageGOText15";
    private static final String DETAIL_BASE_URL = "http://www.sda.gov.cn/WS01";
    private static final String RGX_SEARCH_URL = "/wbpp/generalsearch\\?sort=true&sortId=CTIME&columnid=CLID%7CBCID&relation=MUST%7CMUST&tableName=Region&colNum=2&qryNum=2&curPage=\\d+&qryidstr=CLID%7CBCID&qryValue=cl0885%7C0018&record=20&mytarget=~blank&dateFormat=yyyy%C4%EAMM%D4%C2dd%C8%D5&titleLength=-1&subTitleFlag=0&classStr=%7C-1%7C-1%7CListColumnClass15%7CLawListSub15%7Clistnew15%7Clisttddate15%7Clistmore15%7Cdistance15%7Cclasstab15%7Cclasstd15%7CpageTdSTR15%7CpageTdSTR15%7CpageTd15%7CpageTdF15%7CpageTdE15%7CpageETd15%7CpageTdGO15%7CpageTdGOTB15%7CpageGOButton15%7CpageDatespan15%7Cpagestab15%7CpageGOText15";
    ...
    public void process(Page page) {
        logger.info("======================>>>  MedicalGMPHNProcessor start!");
        ...
        try {
            if (page.getUrl().regex(BASE_URL + RGX_SEARCH_URL).match()) {
                ...
                logger.info("===========GMP认证记录============");
                if(page.getUrl().toString().equals("http://www.sda.gov.cn/WS01/CL0885/129566.html")){
                    logger.info("开始重现");
                }
            ...
            logger.info("MedicalGMPHNProcessor process end!");
        } catch (Exception e) {
            e.printStackTrace();
            logger.error("MedicalGMPHNProcessor process error:", e);
            ...
            logger.error("======================>>>  MedicalGMPHNProcessor end!");
        }
    }
    ...
    public static void main(String[] args) {
        Spider.create(new MedicalGMPHNProcessor())
