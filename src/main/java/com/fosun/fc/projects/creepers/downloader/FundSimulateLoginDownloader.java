 ...
 * @see
 */
@Component("FundSimulateLoginDownloader")
@Scope("prototype")
public class FundSimulateLoginDownloader extends AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            if (statusAccept(acceptStatCode, statusCode)) {
                ...
                if (request.getUrl().startsWith(param.getOrderUrl(BaseConstant.OrderUrlKey.CAPTCHA_URL))) {
    ...
    public FundSimulateLoginDownloader setParam(CreepersLoginParamDTO param) {
        this.param = param;
        return this;
    }
    ...
    protected Page addToCycleRetry(Request request, Site site) {
        ...
        if (cycleTriedTimesObject == null) {
            ...
            if (cycleTriedTimes >= site.getCycleRetryTimes()) {
                String updateQuery = "update t_creepers_list_fund t set t.flag = '2' where t.user_code = '" + param.getLoginName() + "'";
                try {
