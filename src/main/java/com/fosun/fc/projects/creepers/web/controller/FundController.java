...
public class FundController extends BaseController{
    ...
    public String queryInfo(Model model, String userCode) {
        ...
        ArrayList<HashMap<String, Object>> basicList = (ArrayList<HashMap<String, Object>>) resultMap.get(CreepersConstant.TableNamesFund.T_CREEPERS_FUND_BASIC.getMapKey());
        List<Map<String, Object>> basicDetailList = (List<Map<String, Object>>) resultMap.get(CreepersConstant.TableNamesFund.T_CREEPERS_FUND_BASIC_DETAIL.getMapKey());
        List<Map<String, Object>> extraList = (List<Map<String, Object>>) resultMap.get(CreepersConstant.TableNamesFund.T_CREEPERS_FUND_EXTRA.getMapKey());
        List<Map<String, Object>> extraDetailList = (List<Map<String, Object>>) resultMap.get(CreepersConstant.TableNamesFund.T_CREEPERS_FUND_EXTRA_DETAIL.getMapKey());
        List<Map<String, Object>> loansList = (List<Map<String, Object>>) resultMap.get(CreepersConstant.TableNamesFund.T_CREEPERS_FUND_LOANS.getMapKey());
        ...
        model.addAttribute("extraDetailResultList",
                extraDetailList);
        model.addAttribute("loansResult",
                loansList.get(0));
