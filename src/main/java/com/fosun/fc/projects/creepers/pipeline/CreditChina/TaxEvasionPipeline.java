        ...
        try {
            ...
            if (!CommonMethodUtils.isEmpty(taxEvasionMapList)) {
                ...
                if (!CommonMethodUtils.isEmpty(taxEvasionDetailMapList)) {
                    // map转entity
                    List<TCreepersTaxEvasionDetail> detailEntityList = CommonMethodUtils.mapList(taxEvasionDetailMapList,
                            new TCreepersTaxEvasionDetail());
                    Map<String, String> map = new HashMap<String, String>();
                    for (TCreepersTaxEvasionDetail entity : detailEntityList) {
                        CommonMethodUtils.setByDT(entity);
                    ...
                    creepersTaxEvasionDetailServiceImpl.saveEntity(detailEntityList);
                }
