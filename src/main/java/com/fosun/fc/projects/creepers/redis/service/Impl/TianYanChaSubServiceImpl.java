...
public class TianYanChaSubServiceImpl implements IRedisSubService {
    ...
    public void handleMessage(Serializable message) {
        ...
        logger.info("=============>TianYanChaSubServiceImpl.handleMessage start!");
        // 接收消息
        String taskType = message.toString();
        // 增加异常处理
        try {
        	creepersTianYanChaBaseInfoServiceImpl.processByRequest();
            logger.info("=============>TianYanChaSubServiceImpl.handmleMessage end!");
        } catch (Exception e) {
            e.printStackTrace();
            // 异常处理
            ...
            logger.error("=============>TianYanChaSubServiceImpl.handleMessage end!");
        }
