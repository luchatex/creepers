...
public class JsonValidator {
    ...
    /**
     * 验证一个字符串是否是合法的JSON串,默认情况下空字符串不是json
     *
     * @param input 要验证的字符串
     ...
     *
     * @param input 要验证的字符串
     * @param isBlank true 空字符串是json，false 空字符串不是json
     * @return true-是json，false-不是json
     */
    public static boolean validate(String input,Boolean isBlank) {
        input = input.trim();
    ...
    public static void main(String[] args) throws FileNotFoundException{
        String jsonStr = "{\"name\":\"lzp\"}";
        System.out.println(jsonStr+":"+ validate(jsonStr));
    }
}
