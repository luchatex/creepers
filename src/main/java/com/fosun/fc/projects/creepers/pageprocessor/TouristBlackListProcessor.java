...
import com.fosun.fc.projects.creepers.utils.RedisSpider;
...
//                .thread(2).runAsync();
        RedisSpider.create(new TouristBlackListProcessor()).setDownloader(new HttpRequestDownloader().setParam(param)).setKey("tour")
        .thread(2).runAsync();
    }
}
